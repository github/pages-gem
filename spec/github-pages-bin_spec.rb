...
describe(GitHubPages) do
  ...
  it "outputs the branch" do
    expect(`bundle exec ruby ./bin/github-pages branch`).to eql("gem 'github-pages', :branch => 'master', :git => 'git://github.com/github/pages-gem'\n")
  end

  it "detects the CNAME when running health check" do
    File.write("CNAME", "foo.invalid")
    expect(`bundle exec ruby ./bin/github-pages health-check`).to include("Checking domain foo.invalid...")
    File.delete("CNAME")
  end
end
